...
const AddJob = ({ delay, }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      await api.post('jobs/create', formData).then(() => dispatch(completeRequest())).catch((e)=>dispatch(errorRequests()))
      dispatch(addMessage('Congratulations, your job has been successfully added!'));
        ...
        <form action="">
          ...
          >
            ...
            {errorRequest && <motion.h5
              ...
              className="password-error"
            >
              Oops! It looks like there was an issue adding your job. Please double-check your information and try again. If the problem persists, feel free to reach out to our support team for assistance. We're here to help!"
            </motion.h5>}
          </motion.div>
        </form>
      </div>
